package com.daxing.epubtestdemo.dialog.base;
...
import com.daxing.epubtestdemo.util.UICompatUtil;
import com.daxing.epubtestdemo.util.UIHelper;
...
public abstract class BaseDialogFrag extends DialogFragment {
     ...
     * @param context
     */
    public BaseDialogFrag initWithContext(Context context) {
     ...
     */
    public BaseDialogFrag setOnCancelListener(DialogInterface.OnCancelListener cancelListener) {
     ...
     */
    public BaseDialogFrag setOnDismissListener(DialogInterface.OnDismissListener dismissListener) {
